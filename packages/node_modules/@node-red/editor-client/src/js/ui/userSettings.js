...
RED.userSettings = (function () {
    ...
    function createAISettingsPane() {
        ...
        providers.forEach(function(providerInfo) {
            ...
            var providerTitle = $('<h3 style="margin: 0; color: #fff; font-size: 16px;">' + providerInfo.name + '</h3>').appendTo(providerHeader);
        ...
        function createKeyRow(container, providerId, key, index) {
            ...
            var keyRowTop = $('<div style="display: flex; gap: 10px; align-items: center;"></div>').appendTo(keyRow);
            ...
            // Enabled toggle
            var enabledLabel = $('<label style="display: flex; align-items: center; color: #aaa; font-size: 12px;"><input type="checkbox" class="red-ui-ai-key-enabled" style="margin-right: 5px;">Enabled</label>').appendTo(keyRowTop);
            ...
            // Delete button
            var deleteButton = $('<button class="red-ui-button red-ui-button-small" style="background-color: #c9302c;">Delete</button>').appendTo(keyRowTop);
        ...
        function updateProviderKeys(providerId, keys) {
            ...
            aiProviders[providerId].keys = keys.map(function(k) {
                ...
                if (originalKey && originalKey.apiKey) {
                    ...
                    if (!k.hasOwnProperty('apiKey') || !k.apiKey || k.apiKey === '') {
