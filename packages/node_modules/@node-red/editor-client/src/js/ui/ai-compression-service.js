...
RED.aiCompressionService = (function() {
    ...
    function deduplicateNodeTypes(nodeTypes) {
        ...
        for (var nodeType in nodeTypes) {
            if (!nodeTypes.hasOwnProperty(nodeType)) continue;
        ...
        if (duplicates.length > 0) {
            console.log('Compression: Removed ' + duplicates.length + ' duplicate/similar node types');
        }
    ...
    function compressNodeTypes(nodeTypes) {
        ...
        if (reduction > 0) {
            console.log('Compression: Node types reduced by ' + reduction + '% (' + 
    ...
    function deduplicateHistory(history) {
        ...
        if (deduplicated.length < history.length) {
            console.log('Compression: Removed ' + (history.length - deduplicated.length) + ' duplicate messages from history');
        }
