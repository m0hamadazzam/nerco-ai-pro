RED.chatbot = (function () {
    ...
    function addSystemMessage(message, isWarning) {
        ...
        if (message !== "Welcome to Node-RED Assistant! I can help you create flows or answer questions about Node-RED. Ask me anything or describe a flow you'd like to build." && !isWarning) {
