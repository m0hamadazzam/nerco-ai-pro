RED.chatbot = (function () {
    ...
    function createModelSelector() {
        ...
        var selectorWrapper = $('<div style="display: flex; align-items: center; gap: 10px;"></div>').appendTo(selectorContainer);

        var label = $('<label style="color: #aaa; font-size: 12px; white-space: nowrap;">Model:</label>').appendTo(selectorWrapper);
